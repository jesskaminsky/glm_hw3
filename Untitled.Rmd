...
(c) When comparing the exact model predicting probability of passing from midterm score to a model with random noise added - the difference in residual deviance between the two models is 3.7e-17. We can conclude that when a pure noise predictor is added the residual deviance should not decrease at all.
```{r, echo = FALSE}
noise <- rnorm (100,0,1)
